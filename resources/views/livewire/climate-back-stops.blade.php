...
<div>
    ...
    <div class="container-fluid">
        ...
        <x-table.table title="UNDP Users" >
            <x-slot name="headers" >
                <th>#</th>
                <th>Name</th>
                <th>Email</th>
                ...
                @foreach($undps as $index => $user)
                    ...
                    <td>
                        <span>
                            ...
                            <button style="cursor:pointer"  type="button" class="btn btn-primary" data-toggle="modal" data-target="#basicModal" wire:click="edit({{ $user->id }})"  data-placement="top" data-toggle="modal" data-target="#basicModal" title="Edit">
